...
1.  **Open the source code and start editing!**
    ...
    Open the `my-blog-starter` directory in your code editor of choice and edit `src/pages/index1.js`. Save your changes and the browser will update in real time!
